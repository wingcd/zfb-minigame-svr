...
-- 插入测试配置数据
INSERT INTO `yalla_config` (`app_id`, `api_key`, `secret_key`, `base_url`, `timeout`, `retry_count`, `enable_log`, `status`, `remark`, `created_at`, `updated_at`) VALUES
('test_app', 'test_api_key_12345', 'test_secret_key_67890', 'https://test-api.yalla.com', 30, 3, 1, 1, '测试应用配置', NOW(), NOW()),
('test_app_1', 'prod_api_key_12345', 'prod_secret_key_67890', 'https://api.yalla.com', 30, 3, 0, 1, '生产应用配置1', NOW(), NOW()),
('test_app_2', 'dev_api_key_12345', 'dev_secret_key_67890', 'https://dev-api.yalla.com', 10, 1, 1, 1, '开发应用配置2', NOW(), NOW());
